...
namespace CKK.Online
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /***** PRE DAPPER - ENTITY FRAMEWORK STUFF*****/
            //services.AddDbContext<CKKOnlineContext>(options =>
            //        options.UseSqlServer(Configuration.GetConnectionString("CKKOnlineContext")));
        }
